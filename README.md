...
<p>
  ...
  <img src="https://img.shields.io/badge/ALLaM-in--Kingdom-8fc9a8?style=flat-square&labelColor=0a0e12" alt="ALLaM, hosted in-Kingdom" />
</p>
...
| 🤖 **Captain Adel** | RAG over the corpus, generated by **ALLaM** on in-Kingdom inference. Answers cite the Part/section they came from, and refuse when retrieval comes up empty. |
...
flowchart TB
    ...
    GEM["ALLaM · in-Kingdom<br/>RAG over the GACAR corpus"]
