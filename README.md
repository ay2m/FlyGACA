...
| 🤖 **Captain Adel** | RAG over the corpus (Genkit + Gemini). Answers cite the Part/section they came from, and refuse when retrieval comes up empty. |
...
flowchart TB
    ...
    GEM["Gemini via Genkit<br/>RAG over the GACAR corpus"]
